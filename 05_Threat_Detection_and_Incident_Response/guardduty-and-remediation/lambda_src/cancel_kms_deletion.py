"""
cancel_kms_deletion.py — guardduty-and-remediation
...
def lambda_handler(event, context):
    ...
    try:
        ...
        message = (
            f"[Auto-Remediation] KMS key deletion cancelled.\n"
            f"KeyId: {key_id}\n"
            f"Actor: {actor}\n"
            f"Action: CancelKeyDeletion + EnableKey\n"
            f"Note: Review whether this key deletion was intentional."
        )
        _publish_sns(subject="[GuardDuty Remediation] KMS Key Deletion Cancelled", message=message)
